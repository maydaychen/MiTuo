...
public class UnFinishedOrderAdapter extends RecyclerView.Adapter<UnFinishedOrderAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_unfinished_order, parent, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        if (mData != null) {
            ...
            viewHolder.time.setText(String.format(mContext.getResources().getString(R.string.data_time), mData.get(position).getTime()));
        }
